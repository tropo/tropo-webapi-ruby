...
post '/index.json' do
  ...
  say1 = {:value => "Remember, you have a meeting at 2 PM",
  ...
  say2 = {:value => "Remember, you have a meeting at 2 PM",
    :allowSignals => ["say2sig1", "say2sig2"],
      :as => "DIGITS",
      :name => "say2inmessage2",
      :required => "true",
      :voice => "allison",
  ...
  t.message :say => [say1,say2],
    :to => ["+13055551212","+8613412348765"],
    :from => "3055551000",
    :voice =>"dave",
    :timeout=>10,
    :answerOnMedia=>false,
